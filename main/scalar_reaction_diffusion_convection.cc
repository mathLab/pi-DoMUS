...
int main (int argc, char *argv[])
{
  ...
  std::string pde_name="srdc";
  My_CLP.setOption("pde", &pde_name, "name of the PDE (srdc: scalar reaction diffusion convection)");
      ...
      if (pde_name == "srdc")
        {
          ...
          print_status(   "Scalar Reaction Diffusion Convection Equation",
                          prm_file,
                          dim,
                          spacedim,
                          n_threads,
